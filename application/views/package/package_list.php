<style>
    .header-pic-am { position: absolute; z-index:99; color: #fff; margin-left: 2%; }
    .am-img-rp {
...
<?php 
$featured_path = 'uploads/package_category/';
?>

	<div class="container">
		<div class="row ">
			
			<h1 class="header-pic-am"><?php echo $sub_title;?> </h1>
			<div class="am-img-rp">
			    <img src="<?php echo $featured_path.$featured_img; ?>" />
			</div>
