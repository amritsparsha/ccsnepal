                    ...
                    <div class="tr-regi-form">
                        ...
                        <?php if (isset($success)) {
                            ...
                            <div class="alert alert-success alert_box">
                                <a href="#" class="close" data-dismiss="alert" aria-label="close"><i
                                            class="fa fa-times"></i></a>
                                <strong>Success!</strong>  <?php echo isset($success)?$success:"" ; ?>
                            </div>
                            <?php
                        }
                        ?>
                        ...
                        <p>Be a part of Complete Corporate Solution Nepal Pvt. Ltd.</p>
                        <form id="register-form" action="<?php echo site_url('login/register') ?>" method="post" role="form" style="display: block;">
                            <div class="col-md-6">
                                <div class="form-group">

                                    <select data-validation="required" id="selectbasic" class="form-control" name="customer_title"  >
                                        <option >Title *</option>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="email" class="form-control"  id="register_email"  placeholder="Email Address *" value="<?php echo (!empty($this->session->userdata('uc_email')))?$this->session->userdata('uc_email'):set_value('email'); ?>" data-validation="required email">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="password" name="confirm_password" class="form-control" data-validation="required length"  id="confirm-password" data-validation-length="max50"  placeholder="Password" value="<?php echo set_value('confirm_password');?>">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <input type="hidden" name="cuc_id" value="<?php echo (!empty($this->session->userdata('cuc_id')))?$this->session->userdata('cuc_id'):null;  ?>">
                                            <input type="submit" name="login-submit" id="register-submit" tabindex="4" class="waves-effect waves-light btn btn-danger btn-large full-btn" value="Register Now">
                                        </div>
                                    </div>
                                </div>
