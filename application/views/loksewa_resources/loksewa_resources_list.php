					...
					<div id="bloggs">
						<?php foreach ($all_resources as $key => $news): ?>						
							<div class="col-md-12 col-sm-12 col-xs-12">
								<!-- box start here -->
								<div class="box">
									<a href="<?php echo site_url('loksewa/'.$news['content_ref_no']); ?>">
										<img src="<?php echo "uploads/content/".$news['featured_img']; ?>" alt="b8" title="b8" class="" height="221px" width="270px">
									</a>
									<div class="matter">
										<h1><a href="<?php echo site_url('loksewa/'.$news['content_ref_no']); ?>">
										...
										<div class="pull-right">
											<a href="<?php echo site_url('loksewa/'.$news['content_ref_no']); ?>">Read more <i class="fa fa-angle-double-right" aria-hidden="true"></i></a>
										</div>
									</div>
								</div>
								<!-- box end here -->
