...
class News extends CI_Controller{
    ...
    public function latest_news($ref_no)
    {
            $detail= $this->news->get_detail_news($ref_no);
            $data['content']= $detail;
     ...
     public function all_news($start_point='')
    {
            $all_news=$this->news->get_all_news();
            ...
            $data['all_news']=array_slice($all_news,$start_point,$this->per_page);
    ...
    public function pagination($id,$start_point,$count,$page)
    {
            ...
            {
                $config['base_url'] =  site_url('news/'.$page.'/'.$id);
