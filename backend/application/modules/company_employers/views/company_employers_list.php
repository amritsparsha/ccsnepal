    ...
    <div class="container-fluid">
        ...
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h4 class="text-themecolor"><?php echo (isset($title))?$title:""; ?></h4>
            </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive m-t-40">
                            <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                ...
                                <?php
                                $i = 1;
                                foreach($company_employers as $row)
                                {
                                    ?>
                                    <tr>
                                        <td><?php echo $i++;?></td>
                                        <td><img src="<?php echo "../uploads/company_employers/".$row['featured_img']; ?>" width="60" /> </td>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                <button type="button" class="btn btn-warning" data-toggle="modal" data-target=".bs-example-modal-lg<?php echo $row['come_id'];?>"><i class="fa fa-eye" ></i></button>


                                                <a href="<?php echo site_url('company_employers/form/'. $row['come_id']);?>" class="btn btn-success" title="Edit"><i class="fa fa-pencil-square-o"></i></a>

                                                <a class="btn btn-danger" data-target="#myModal_delete<?php echo $row['come_id'];?>" data-toggle="modal" title="Delete"><i class="fa fa-trash-o" ></i></a>
                                            </div>
...
<!--                                                            <a href="--><?php //echo site_url('company_employers/company_employers_delete/'. $row['come_id']); ?><!--"><button type="button" class="btn btn-success delete" >OK</button></a>-->
                                            ...
                                            <div class="modal fade bs-example-modal-lg<?php echo $row['come_id'];?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <table class="table table-bordered">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td><img src="../uploads/company_employers/<?php echo $row['featured_img'];?>"  width="20%" /> </td>
                                                                    ...
                                                                    <tr>
                                                                     ...
                                                                     <tr>
                                                                        ...
                                                                        <td><?php echo (!empty($row['comc_id']))?$this->crud->get_detail($row['comc_id'],"comc_id","tbl_company_category")['company_category']:"";?></td>

                                                                    </tr>
                                                                     <tr>
                                                                        <th scope="row">Organization Size</th>
                                                                        <td><?php echo (!empty($row['comem_id']))?$this->crud->get_detail($row['comem_id'],"comem_id","tbl_company_size")['company_size']:"";?></td>
                                                                    </tr>
                                                                     <tr>
                                                                        <th scope="row">Website</th>
                                                                        <td><?php echo $row['employer_website'];?></td>
                                                                     ...
                                                                     <tr>
                                                                        ...
                                                                        <td><?php echo $row['em_contact_email'];?></td>
