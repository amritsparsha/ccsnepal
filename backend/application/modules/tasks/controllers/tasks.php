...
class Tasks extends MX_Controller
{
    ...
    public function assignment_today()
    {
        $table         = 'igc_tasks';
        $data['tasks'] = $this->crud->get_all($table);
        $data['title'] = "Today Assignment List";
        $this->load->view('header', $data);
        $this->load->view('assignment_today');
        $this->load->view('footer');
    }
    public function assignment_upcomings()
    {
        $table         = 'igc_tasks';
        $data['tasks'] = $this->crud->get_all($table);
        $data['title'] = "Upcomings Assignment List";
        $this->load->view('header', $data);
        $this->load->view('assignment_upcomings');
        $this->load->view('footer');
    }
    public function assignment_completed()
    {
        $table         = 'igc_tasks';
        $data['tasks'] = $this->crud->get_all($table);
        $data['title'] = "Comleted Assignment List";
        $this->load->view('header', $data);
        $this->load->view('assignment_completed');
        $this->load->view('footer');
    }
