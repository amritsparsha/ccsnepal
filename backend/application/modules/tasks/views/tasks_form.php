                ...
                <div class="card ">
                    ...
                    <script type="text/javascript">
                        $(document).ready(function(){
                            ...
                            $('.checkboxClass').change(function(e){
                                 var inputValue = $(this).attr("value");
                                    if($(this).is(':checked'))
                                    {
                                        $("." + inputValue).show();
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                <select name="contact_id" class="form-control" required="required">
                                                    <option>Choose Contact</option>
                                                    <?php
                                                    $ascont= $this->crud->get_where("tbl_company_employers",array("company_type"=>"0",'delete_status'=>'0','publish_status'=>'1','active_status'=>'Y'));


                                                    foreach ( $ascont as $cont){

                                                        ?>
                                                        <option value="<?php echo  $cont['come_id'] ?>" <?php echo (isset($tasks['come_id']) && $tasks['come_id'] ==$cont['come_id'])?"selected":"";?>><?php echo $cont['company_employers']; ?> (<?php echo $cont['em_contact_person']; ?>)  </option>
                                                    <?php } ?>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <select name="tasks_status" class="form-control">
                                                    ...
                                                    <option value="0" <?php echo (isset($tasks['tasks_status']) && $tasks['tasks_status'] =="0")?"selected":"";?>>Not Started On</option>
                                                    <option value="1"  <?php echo (isset($tasks['tasks_status']) && $tasks['tasks_status'] =="1")?"selected":"";?>>Working On</option>
                                                    <option value="2"  <?php echo (isset($tasks['tasks_status']) && $tasks['tasks_status'] =="2")?"selected":"";?>>Completed On</option>
                                                ...
                                                <div class="multiselect">
                                                    ...
                                                    <div id="checkboxes" name="assign_to[]">
                                                        ...
                                                        foreach ( $amus as $cuse){
                                                            ...
                                                            ?>
                                                            <label for="one">
                                                                <input type="checkbox" name="assign_to[]"   value="<?php echo  $cuse['user_id'] ?>" <?php echo (array_key_exists($cuse['user_id'],$tasks_assign))?"checked":"";?> class="checkboxClass" id="one<?php echo  $cuse['user_id'] ?>" />
                                                ...
                                                <div>
                                                    ...
                                                    foreach ($amus as $amst){
                                                        ...
                                                        <div class="<?php echo  $amst['user_id'] ?>  box">
                                                            ...
                                                            <textarea rows="5" cols="10" name="tasks_detail[]" id="tasks_detail<?php echo  $amst['user_id'] ?>"><?php echo (array_key_exists($amst['user_id'],$tasks_assign)) ? $tasks_assign[$amst['user_id']]['tasks_detail']:""; ?></textarea>
