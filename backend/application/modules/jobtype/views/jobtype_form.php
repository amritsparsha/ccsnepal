                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <input type="text" name="jobtype"  size="50" data-validation="required" value="<?php echo (isset($jobtype['jobtype']) && $jobtype['jobtype'] !="") ? $jobtype['jobtype']:""; ?>"  autocomplete="off" class="regular-text form-control required valid" kl_virtual_keyboard_secure_input="on">
                                        </div>
                                    </div>
                                    <!--/span-->
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <textarea rows="5" cols="10" name="jobtype_detail" id="jobtype_detail"><?php echo (isset($jobtype['jobtype_detail']) && $jobtype['jobtype_detail'] !="") ? $jobtype['jobtype_detail']:""; ?></textarea>
                                            </div>
                                        </div>
                                        <!--/span-->
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="publish_status" class="publish_status form-control">
                                                ...
                                                <option value="1"  <?php echo (isset($jobtype['publish_status']) && $jobtype['publish_status'] =="1")?"selected":"";?>>Yes</option>
                                                <option value="0"  <?php echo (isset($jobtype['publish_status']) && $jobtype['publish_status'] =="0")?"selected":"";?>>No</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="row">
                                            <div class="col-md-offset-3 col-md-9">
                                                <input type="hidden" name="comem_id" value="<?php echo (isset($jobtype['comem_id']) && $jobtype['comem_id'] !="") ? $jobtype['comem_id']:""; ?>">
...
<script>
    CKEDITOR.replace( 'jobtype_detail',{
