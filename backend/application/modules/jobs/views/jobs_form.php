                        ...
                        <div class="vtabs">
                                                                ...
                                                                <label for="organization_size">Preferred Education<span class="asteriskField">*</span></label>
                                                                  <select name="pref_edu" data-validation="required" autocomplete="off" class="regular-text form-control required valid" kl_virtual_keyboard_secure_input="on">
                                                                    ...
                                                                    <?php foreach ($education_levels as $key => $education_level): ?>
                                                                            <option value="<?php echo $education_level['education_level_id']; ?>" <?php echo (isset($jobs['pref_edu']) && $jobs['pref_edu'] ==$education_level['education_level_id']) ?"selected":""; ?> >
                            ...
                            <div class="tab-pane p-20" id="job7" role="tabpanel">
                                    ...
                                    <div class="form-group row">
                                                            ...
                                                            <div class="col-md-12">
                                                                <label for="organization_size">Employer Reference:</label>
                                                                  <select name="admin_employer_ref" autocomplete="off" class="regular-text form-control required valid" kl_virtual_keyboard_secure_input="on">
                                                                    <option value="0">None</option>
                                                                    <?php foreach ($employers as $key => $employer): ?>
                                                                            <option value="<?php echo $employer['come_id']; ?>" <?php echo (isset($jobs['admin_employer_ref']) && $jobs['admin_employer_ref']==$employer['come_id'])?"selected":""; ?>>
                                                                                <?php echo $employer['company_employers']; ?>
                                                                            </option>
                                                                    <?php endforeach ?>    
                                                                        </select>
                                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group has-danger row">
                                            <div class="col-md-12">
                                                <label for="category_image">Jobs Banner</label>
                                                <?php
                                                if(isset($jobs['featured_img']))
                                                {
                                                    ...
                                                    <div class="remove_option">
                                                        ...
                                                        $path  =  '../uploads/jobs/';
                                                        ?>
                                                        <img src="<?php echo $path. $jobs['featured_img'];?>" alt="featured_image" style="width: 20%;">

                                                        <span class="btn btn-info remove_btn" id="btn_remove">Remove</span>
                                                    </div>
                                                    <input type="hidden" name="pre_featuredimg" value="<?php echo $jobs['featured_img']; ?>">
                                                    <div id="image_input">
