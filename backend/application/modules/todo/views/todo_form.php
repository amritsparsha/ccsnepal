                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <input type="text" name="assign_date" class="form-control" data-validation="required" placeholder="End Date- YY-mm-dd" id="mdate" value="<?php echo (isset($todo['assign_date']) && $todo['assign_date'] !="") ? $todo['assign_date']:""; ?>">
