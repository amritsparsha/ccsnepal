...
<div id="wrapper">
    <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
        ...
        $this->db->where('come_id', $user_id);
        $detail = $this->db->get('tbl_company_employers')->row_array();
        ...
        <div class="sidebar-collapse">
            <ul class="nav" id="main-menu">
                ...
                <li>
                 ...
                 <li>
                    <a href="<?php echo site_url('biodata');?>"><i class="fa fa-qrcode "></i>Biodata</a>
                </li>
                 <li>
                    <a href="<?php echo site_url('jobs');?>"><i class="fa fa-qrcode "></i>Jobs</a>
                </li>
                <li>
