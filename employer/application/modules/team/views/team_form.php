                            ...
                            <table class="form-table">
                                ...
                                <tr valign="top">
                                    ...
                                    <td style="background: transparent none repeat scroll 0% 0%;">
                                        <input type="text" name="team_title" data-validation-allowing="float"
                                ...
                                <tr valign="top">
                                    ...
                                    <td style="background: transparent none repeat scroll 0% 0%;">
                                        <input type="text" name="team_caption" data-validation-allowing="float"
                                              data-validation="required"
                                               value="<?php echo (isset($detail['team_caption']) && $detail['team_caption'] != "") ? $detail['team_caption'] : ""; ?>"
                                               autocomplete="off" class="regular-text requ form-control ired valid"
                                               kl_virtual_keyboard_secure_input="on"></td>
                                </tr>

                                <tr valign="top">
                                    <th style="background: transparent none repeat scroll 0% 0%;" scope="row"><label>Short Bio
                                            <span class="asterisk">*</span>
                                        </label></th>
                                    <td style="background: transparent none repeat scroll 0% 0%;">
                                        <textarea class="form-control"  rows="10" name="team_description"><?php echo (isset($detail['team_description']) && $detail['team_description'] != "") ? $detail['team_description'] : ""; ?></textarea>
                                        </td>
                                </tr>
                                ...
                                <tr valign="top" id="featured_img">
                                    ...
                                    <td style="background: transparent none repeat scroll 0% 0%;">
                                        ...
                                        if(isset($detail['team_image']) && file_exists($path.$detail['team_image']))
                                        {
                                            ...
                                            <input type="hidden" name="pre_team_image" value="<?php echo $detail['team_image']; ?>">
                                            <div id="image_input">
