                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade active in" id="home">
                            ...
                            <table class="form-table">
                                ...
                                <tr valign="top">
                                    <th style="background: transparent none repeat scroll 0% 0%;" scope="row"><label>Career Title <span class="asterisk">*</span>
                                        </label></th>
                                    <td style="background: transparent none repeat scroll 0% 0%;">
                                        <input type="text" name="career_title" data-validation="required"  size="50" data-validation="number required" value="<?php echo (isset($detail['career_title']) && $detail['career_title'] !="") ? $detail['career_title']:""; ?>"  autocomplete="off" class="regular-text required valid" kl_virtual_keyboard_secure_input="on">
                                ...
                                <tr valign="top">
                                    ...
                                    <td style="background: transparent none repeat scroll 0% 0%;">
                                       <textarea name="career_content" id="career"><?php echo (isset($detail['career_content']) && $detail['career_content'] !="") ? $detail['career_content']:""; ?></textarea>
                                    </td>
                                </tr>
                        ...
                        <p class="submit">
                            <input type="hidden" name="career_id" value="<?php echo (isset($detail['career_id']) && $detail['career_id'] !="") ? $detail['career_id']:""; ?>">
                            <input type="submit" name="Setting Btn" id="btn_career" class="button" value="Save">
                        </p>
