...
////===========================================for Work Experience===========555555555555555=================================
    ...
    ?>
        var experience_html9='</select></div><div class="col-md-4"><select name="exp_end_month[]" autocomplete="off" class="regular-text form-control required valid" kl_virtual_keyboard_secure_input="on"><option value="">----------</option>';
    <?php 
            $body5='';
            foreach ($months as $key => $month)
            {
    ...
    ?>    
        var experience_html11='</select></div></div></div></div><div id="exp_cur_work_no"><div class="row"><div class="col-md-12"><div class="form-group row"><div class="col-md-4"><label for="organization_size">End Date</label></div><div class="col-md-4"><select name="exp_start_year[]" autocomplete="off" class="regular-text form-control required valid" kl_virtual_keyboard_secure_input="on"><option value="">----------</option>';

    <?php echo "var experience_html12='".$body4."';"; ?>

         var experience_html13='</select></div><div class="col-md-4"><select name="exp_start_month[]" autocomplete="off" class="regular-text form-control required valid" kl_virtual_keyboard_secure_input="on"><option value="">----------</option>';
