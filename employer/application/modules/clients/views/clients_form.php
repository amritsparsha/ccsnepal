                                ...
                                <tr valign="top">
                                    ...
                                    <td style="background: transparent none repeat scroll 0% 0%;">
                                        <input type="text" name="clients_caption" data-validation-allowing="float"
                                               ...
                                               autocomplete="off" class="regular-text required valid form-control"
                                               kl_virtual_keyboard_secure_input="on"></td>
                                </tr>

                                <tr valign="top">
                                    <th style="background: transparent none repeat scroll 0% 0%;" scope="row"><label>Client Link
                                            <span class="asterisk">*</span>
                                        </label></th>
                                    <td style="background: transparent none repeat scroll 0% 0%;">
                                        <input type="text" name="client_lnik" data-validation-allowing="float"
                                               data-validation="required"
                                               value="<?php echo (isset($detail['client_lnik']) && $detail['client_lnik'] != "") ? $detail['client_lnik'] : ""; ?>"
                                               autocomplete="off" class="regular-text required valid form-control"
                                               kl_virtual_keyboard_secure_input="on"></td>
                                </tr>
