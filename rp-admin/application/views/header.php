...
<head>
    ...
    <title>Rupakot Holidays | <?php echo $title;?></title>
...
<div id="wrapper">
    <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#">Rupakot Holidays</a>
        </div>
        <?php
        ...
        <div class="sidebar-collapse">
            <ul class="nav" id="main-menu">
                <li class="text-center">
                    <img src="themes/img/find_user.png" class="user-image img-responsive"/>
                </li>
                ...
                <li>
                    <a href="<?php echo site_url('site_settings');?>"><i class="fa fa-qrcode fa-3x"></i> Site Settings</a>
                </li>
                <li>
                    <a href="<?php echo site_url('user');?>"><i class="fa fa-user fa-3x"></i>User</a>
                </li>
                <li>
                    <a href="<?php echo site_url('primary_menu');?>"><i class="fa fa-bars fa-3x"></i>Primary Menu</a>
                </li>
                <li>
                    <a href="<?php echo site_url('category_sorting');?>"><i class="fa fa-sort-amount-desc fa-3x"></i>Category Sorting</a>
                </li>
